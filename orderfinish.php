        ...
        <tr>
            <td colspan="2" style="width: 100%">
                <div class="zone" style="height: 34mm;position: relative;font-size: 5mm;">
					...
					<span style="position: absolute; left: 32mm; top: 10mm; font-size: 28px; color: red">Apoy Wisata</span><br />
                    <span style="position: absolute; left: 32mm; top: 18mm; font-size: 16px;">Bandung, <?php echo $date; ?></span>
